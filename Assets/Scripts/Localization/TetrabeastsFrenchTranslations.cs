...
public static class TetrabeastsFrenchTranslations
{
    ...
    static Dictionary<string, string> BuildExactText()
    {
        ...
        Add(text, "Spawn Spike Effects", "Générer des effets de pointes");
        Add(text, "The boss will spawn multiple spike floor effects on the board. They can be spawned individually scattered across the board or in patterns of 2x2, 1x4, or 4x1.", "Le boss génère plusieurs effets de sol à pointes sur le plateau. Ils peuvent être dispersés individuellement ou apparaître en motifs 2x2, 1x4 ou 4x1.");
        ...
        Add(text, "Fill each grid cell in a row to launch an attack. Monster Units and Obstacles count as a filled cell. Floor effects do not count as a filled cell. Monster units in the cleared row contribute their attack stats for damage calculation and partially fill the player's special gauge.", "Remplissez chaque case d'une rangée pour lancer une attaque. Les unités monstrueuses et les obstacles comptent comme des cases remplies. Les effets de sol ne comptent pas comme des cases remplies. Les unités de la rangée complétée ajoutent leur attaque au calcul des dégâts et remplissent partiellement la jauge spéciale du joueur.");
        ...
        Add(text, "The Lightning Bolt special will activate immediatley when set. All monster units and destructible floor effects will be destroyed in that column. Stone obstacles will take partial damage if they are in the affected area.", "Le spécial Éclair s'active immédiatement lorsqu'il est placé. Toutes les unités monstrueuses et les effets de sol destructibles de cette colonne sont détruits. Les obstacles de pierre subissent des dégâts partiels s'ils se trouvent dans la zone.");
        ...
        Add(text, "Spike Floor Effect", "Effet de sol à pointes");
        Add(text, "Spike floor effects deal a high amount of damage to any monster unit placed on their cell. They can be destroyed with the lightning special block.", "Les effets de sol à pointes infligent de gros dégâts à toute unité monstrueuse placée sur leur case. Ils peuvent être détruits avec le bloc spécial foudre.");
